            ...
            {!file ? (
                ...
                >
                    ...
                    <div className="space-y-4">
                        {/* Upload icon */}
                        <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-purple-500/20 to-indigo-500/20 flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">
                                or <span className="text-purple-400 underline cursor-pointer">browse files</span>
                            </p>
                        </div>
